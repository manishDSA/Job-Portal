...
import { Loader2, Mail, Lock, Eye, EyeOff, UserCheck, Briefcase, X } from 'lucide-react';
...
const Login = () => {
    ...
    const triggerGoogleLogin = useGoogleLogin({
        ...
        onError: (error) => {
            console.warn("Google OAuth popup error (invalid client ID or popup closed):", error);
            openGoogleDirectModal();
        }
    });
